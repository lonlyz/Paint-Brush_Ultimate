...
class header:
    ...
    def __init__(self,window,mod,stateObj):
        ...
        self.ref.Button(self.frame, text="Salvar arquivo", command=lambda: figs.save()).pack(side="left", fill="x", pady=5, padx=5)
        self.ref.Button(self.frame, text="Abrir arquivo", command=lambda: figs.open()).pack(side="left", fill="x", pady=5, padx=5)
